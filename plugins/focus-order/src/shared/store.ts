...
export function defaultState(): FocusOrderState {
  return {
...
export function stateDirectory(): string {
  return process.env.HERDR_PLUGIN_STATE_DIR
    ?? join(homedir(), ".config", "herdr", "focus-order");
}

export function statePath(): string {
  return join(stateDirectory(), "focus-order.json");
}

export function loadState(): FocusOrderState {
  try {
...
export function saveState(state: FocusOrderState): void {
