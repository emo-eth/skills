...
Focused evidence for v0.2: strict TypeScript compilation, 26 Node host tests, 18 Python contract tests, and real Pi 0.84.1 and OMP 17.2.15 native-runner execution. The isolated CLI auth smoke returned a truthful missing state without exposing a secret. Five independent correctness, security, performance, content-contract, and auth-contract reviewers found and verified fixes for all material findings; their final post-fix verdicts were clean. Historic v0.1 live OMP evidence remains in `docs/log/2026-08-28-grok-search-tools.md`; the new structured retrieval shape has focused and native-host proof but has not spent a live xAI request in this change [verified-focused].
...
| X/Twitter Grok search, fetch, and auth | `skills/grok-search/SKILL.md`, `docs/prds/2026-09-02-grok-search/vibe.md`, `docs/log/2026-08-28-grok-search-tools.md` | `skills/grok-search/scripts/grok-search.py`, `scripts/grok_x.py`, `src/` | strict TypeScript check; 26 Node and 18 Python tests; native Pi 0.84.1 and OMP 17.2.15 runners; isolated missing-auth smoke; five-lens adversarial audit; historic v0.1 live OMP search/fetch evidence | verified-focused v0.2; historic verified-live v0.1 |
