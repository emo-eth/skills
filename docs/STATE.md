...
| OMP-native pstack | upstream `cursor/plugins@46125561306434d8a1d7745d540d8932ab0cd2a2` | 44 directories under `skills/`, rooted at `skills/poteto-mode/` | frontmatter, link, OMP-vocabulary, helper test, install, and live-discovery checks pending | documented |
