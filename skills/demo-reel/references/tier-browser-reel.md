...
If `agent-browser` is not installed, inform the user: "`agent-browser` is not installed. Install it manually if you want to use this tier." Then fall back to a lower tier (static screenshots or skip).
