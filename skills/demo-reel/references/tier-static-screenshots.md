...
If `agent-browser` is not installed, inform the user: "`agent-browser` is not installed. Install it manually if you want to use this tier." Then skip to the CLI or fallback sections below.
