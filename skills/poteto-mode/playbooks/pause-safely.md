...
**You own a clean stop. Leave a checkpoint a cold-start agent can resume from.** For "pause safely", "I need to go offline", "restart OMP", or imminent context compaction. This is explicit only. "Keep going" and "going to bed, keep going" route to Autonomous run instead.
